 ...
 */
public class BuscarClienteComanda extends javax.swing.JFrame {
        
private ControlNavegacion control;
private JCheckBox checknombre, checkTelefono, checkCorreo;
    /**
     * Creates new form BuscarClienteComanda
     */
    public BuscarClienteComanda() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setFont(new java.awt.Font("Devanagari MT", 0, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarClienteComanda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarClienteComanda().setVisible(true);
            }
        });
    }
